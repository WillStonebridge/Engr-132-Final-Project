...
%code for concentration curves with tangent line
y_tang1 = Vo(1) .* x_tang1;
y_tang2 = Vo(2) .* x_tang2;
y_tang3 = Vo(3) .* x_tang3;
y_tang4 = Vo(4) .* x_tang4;
y_tang5 = Vo(5) .* x_tang5;
y_tang6 = Vo(6) .* x_tang6;
y_tang7 = Vo(7) .* x_tang7;
y_tang8 = Vo(8) .* x_tang8;
y_tang9 = Vo(9) .* x_tang9;
y_tang10 = Vo(10) .* x_tang10;
%% ____________________
